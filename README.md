...
**Задача:** Необходимо построить n хранлищ. Сужествует m > n место для их постройуи. В хранилищах хранятся t типа нефти разного качества. У данных типов нефти разная цена. Доставка из точки хранения до точки сбыта также разная. Необходимо: оптимизировать хранение так, чтобы получить максимальную прибыль. 
